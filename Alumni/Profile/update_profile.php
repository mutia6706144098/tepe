<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        $tusername=$_POST['nama_depan'];
        $tpassword=$_POST['nama_belakang'];
        $tnama=$_POST['tempat_lahir'];

        
        $sql="UPDATE tb_alumni SET nim ='1' WHERE username='$tusername' ";
...
<div class="row">
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="nama_depan" name="nama_depan" placeholder="<?php if($_GET["username"]){ echo "$tusername"; } ?>">
  </div>
  </div>
  <div class="col-md-6">
    <div class="form-group">
